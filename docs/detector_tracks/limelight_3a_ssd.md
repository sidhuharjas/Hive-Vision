...
are in [neural-net/README.md](https://github.com/sidhuharjas/Hive-Vision/blob/main/neural-net/README.md).
Short version:

- **Model**: `neural-net/weights/best_limelight3a_ssd_mobilenetv2_300x300.tflite`,
...
- **Classes**: `neural-net/weights/labels.txt` — `yellow_pollen`=0, `red_nectar`=1,
