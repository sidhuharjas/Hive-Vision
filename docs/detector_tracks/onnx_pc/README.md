...
- **Model**: `neural-net/weights/best.onnx`, 960×960 input, raw YOLO tensor output
  (`1×7×18900`, pre-NMS — decode it yourself).
- **Run**: `python neural-net/scripts/detect_video_realtime.py --weights neural-net/weights/best.pt`.
